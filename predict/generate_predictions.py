...
from preprocess.helpers import prepare_dataset_nli_hypothesis_only, compute_accuracy
...
def generate_predictions(model_path, output_file, hypothesis_only=False):
    ...
    if hypothesis_only:
        ...
        from preprocess.helpers import prepare_dataset_nli
...
if __name__ == "__main__":
    ...
    generate_predictions(
        model_path='../outputs/evaluations/hypothesis_only_model/',
        output_file='../outputs/evaluations/hypothesis_only_model/eval_predictions.jsonl',
