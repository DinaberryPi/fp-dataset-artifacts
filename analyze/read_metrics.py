...
if __name__ == "__main__":
    ...
    models = [
        ('../outputs/evaluations/baseline_100k', 'Baseline Model (100K)'),
        ('../outputs/evaluations/hypothesis_only_model', 'Hypothesis-Only Model (Artifact Detector)'),
        ('../outputs/evaluations/debiased_model', 'Debiased Model (100K)')
    ]
